...
import { saveToastConnection } from '@/lib/storage/connections';
...
export default function ToastConnectedPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Save Toast connection to localStorage
      saveToastConnection(address, {
        accessToken,
      ...
      console.error('Failed to save Toast connection:', error);
      setStatus('error');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Connecting Toast...</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Toast Connected!</h2>
          <p className="text-gray-600 mb-4">
            Your Toast POS account has been successfully connected. Redirecting to dashboard...
          </p>
        </div>
      </div>
    </div>
